...
KIND_VARIABLE_LIBRARY = "variable-library"
...
# Deploy order: models before reports, then variable libraries and environments
# before consumers; independent kinds follow (stable within kind).
